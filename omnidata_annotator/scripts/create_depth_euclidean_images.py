"""
  Name: create_depth_euclidean_images.py
  Desc: Creates depth euclidean versions of standard RGB images by using the matterport models.
...
def set_render_settings(scene):
    ...
    world.mist_settings.depth = settings.DEPTH_EUCLIDEAN_MAX_DISTANCE_METERS  # max range
...
if __name__ == "__main__":
    with utils.Profiler("create_depth_euclidean_images.py"):
        main()
