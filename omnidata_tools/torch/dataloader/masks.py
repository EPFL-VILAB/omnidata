'''
The goal of this file is to build a mask to indicate which pixels unproject to valid geometry on the mesh.
Optionally, add mask out pixels surrounding invalid geometry (using maxpool)

Code originally came from https://github.com/EPFL-VILAB/XTConsistency
'''
